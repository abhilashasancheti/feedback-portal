...
$sql1 = "SELECT q12,count(*) FROM formval  GROUP BY q12";
...
$sql2 = "SELECT q13,count(*) FROM formval  GROUP BY q13";
...
$sql3 = "SELECT q14,count(*) FROM formval  GROUP BY q14";
...
<div class="caption capabove alignleft">
<label class="fieldlabel" for="p2f2c"><span class="wordwrap"><span class="pspan timesnewroman" style="text-align:left;font-size:14px;"><span class="ispan" style="font-weight:bold;color:#716D5D" xml:space="preserve">Additional Comments (if any)</span></span></span></label>
<div class="null"></div>
</div>
<div class="control capabove">
<!--<div>
