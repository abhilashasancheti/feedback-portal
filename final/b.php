...
<head>
		...
		<link rel="shortcut icon" href="logo-iitg.gif" type="image/x-icon"/>
      ...
      <img src="iitg.gif" alt="IIT Guwahati">
			...
			<div class="content">
				<div id="form_wrapper" class="form_wrapper">
					<form class="register" action="insert1.php" method="post">
						...
						<div class="bottom">
							...
							<a href="c.php" rel="login" class="linkform">You have an account already? Log in here</a>
							<div class="clear"></div>
						</div>
					</form>
...
<form class="login active" action="login2.php" method="post">
						...
						<div class="bottom">
							...
							<a href="register.html" rel="register" class="linkform">Change your Password, Click here</a>
							<div class="clear"></div>
						</div>
					</form>
					...
					<form class="forgot_password">
						...
						<div class="bottom">
							...
							<a href="c.php" rel="login" class="linkform">Suddenly remebered? Log in here</a>
