...
<title>InstructorFeedback</title>
...
<?php
		...
		$group_by=mysql_query("SELECT distinct(id) FROM formval");
		 echo '<tr>';
				   ...
				   echo "<td align=center>"."The instructor was qualified to teach this course."."</td>";
				   echo "<td align=center>"."The instructor demonstrated enthusiasm for the subject matter."."</td>";
				   echo "<td align=center>"."The instructor was available and helpful to students outside of class."."</td>";
	...
	//lets make a loop and get all news from the database
			...
			if(mysql_num_rows($result)>0)
			{
				 ...
				 {//begin of loop
				   ...
				   echo "<td align=center>".$myrow['q12']."</td>";
				   echo "<td align=center>".$myrow['q13']."</td>";
				   echo "<td align=center>".$myrow['q14']."</td>";
