...
if(isset($_POST['submit']))
  {
		...
		$result = mysql_query("UPDATE  facultyinfo  SET password='$password'  WHERE username='$username'");
		...
		echo "<b>Password is updated successfully!</b><br>You'll be redirected after (1) Seconds";
          echo "<meta http-equiv=Refresh content=1;url=facultyinfo.php>";
  ...
  {//begin of else
   $f_id = $_GET['id'];
    $result = mysql_query("SELECT * FROM  facultyinfo WHERE f_id='$f_id' ");
  ...
  <tr>
    ...
    <td><div align="left">
      <table border="0" width="100%">
        <tr><td> <input type="submit" class="button3 black" name="submit" value="Update"></td><td align="right"><input type="button" name="Back" value="Back"  onclick="javascript: history.go(-1)" class="button3 black" /></td></tr>
      </table>
    </div></td>
  </tr>
</table>
