...
// Check connection
//$t=$_SESSION['tname'];
/*$sql=mysql_query("SELECT * FROM formval where instructor='$t'")or die(mysql_error());
...
echo strlen($r5).'<br>';
*/
$sql1 = "SELECT q1,count(*) FROM formval  GROUP BY q1";
...
$sql2 = "SELECT q2,count(*) FROM formval  GROUP BY q2";
...
$sql3 = "SELECT q3,count(*) FROM formval  GROUP BY q3";
...
$sql4 = "SELECT q4,count(*) FROM formval  GROUP BY q4";
...
$sql5 = "SELECT q5,count(*) FROM formval  GROUP BY q5";
...
$sql6 = "SELECT q6,count(*) FROM formval  GROUP BY q6";
...
$sql7 = "SELECT q7,count(*) FROM formval  GROUP BY q7";
...
$a7_3=0;
$a7_4=0;
		while($rows = mysql_fetch_array($res7))
		{
		             $a=strlen($rows[0]); $b=$rows[1]; 
		                if($a==19)
		                 $a7_1=$b;
...
$sql8 = "SELECT q8,count(*) FROM formval  GROUP BY q8";
...
$a8_3=0;
$a8_4=0;
		while($rows = mysql_fetch_array($res8))
		{
		             $a=strlen($rows[0]); $b=$rows[1]; 
		                if($a==19)
		                 $a8_1=$b;
...
$sql9 = "SELECT q9,count(*) FROM formval  GROUP BY q9";
...
$a9_3=0;
$a9_4=0;
		while($rows = mysql_fetch_array($res9))
		{
		             $a=strlen($rows[0]); $b=$rows[1]; 
		                if($a==19)
		                 $a9_1=$b;
...
$sql10 = "SELECT q10,count(*) FROM formval  GROUP BY q10";
...
$a10_3=0;
$a10_4=0;
		while($rows = mysql_fetch_array($res10))
		{
		             $a=strlen($rows[0]); $b=$rows[1]; 
		                if($a==19)
		                 $a10_1=$b;
...
$sql11 = "SELECT q11,count(*) FROM formval  GROUP BY q11";
...
$a11_3=0;
$a11_4=0;
		while($rows = mysql_fetch_array($res11))
		{
		             $a=strlen($rows[0]); $b=$rows[1]; 
		                if($a==19)
		                 $a11_1=$b;
...
<form id="form" method="post" action="response1.php">
<div id="formcontent">
<div id="sizedcontent">
