...
{
$sql = "UPDATE logininfo SET password='$npass' WHERE username='$user' AND password='$pass'";
$sql = "UPDATE studentinfo SET password='$npass' WHERE username='$user' AND password='$pass'";
}
